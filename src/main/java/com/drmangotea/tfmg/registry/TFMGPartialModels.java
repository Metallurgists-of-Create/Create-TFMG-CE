...
public class TFMGPartialModels {
    ...
    public static final PartialModel
            ...
            CONNECTING_WIRE = block("winding_machine/connecting_wire"),
            CONNECTING_WIRE_ANIMATED = block("winding_machine/connecting_wire_animated");

    // Cogwheel
    public static final PartialModel
            STEEL_COGWHEEL = block("steel_cogwheel"),
            LARGE_STEEL_COGWHEEL = block("large_steel_cogwheel_shaftless"),
            ALUMINUM_COGWHEEL = block("aluminum_cogwheel"),
            LARGE_ALUMINUM_COGWHEEL = block("large_aluminum_cogwheel"),
            SHAFTLESS_ALUMINUM_COGWHEEL = block("aluminum_cogwheel_shaftless"),
            SHAFTLESS_STEEL_COGWHEEL = block("steel_cogwheel_shaftless"),
            SHAFTLESS_LARGE_ALUMINUM_COGWHEEL = block("large_aluminum_cogwheel_shaftless"),
            SHAFTLESS_LARGE_STEEL_COGWHEEL = block("large_steel_cogwheel_shaftless");
    ...
    //TODO: add more
    public static final PartialModel
        VAT_SHAFT = block("industrial_rotor/shaft");
    ...
    public static final Map<TFMGPipes.PipeMaterial, PartialModel> PUMP_COGS = new HashMap<>();
    ...
    static {
        ...
        for (TFMGPipes.PipeMaterial material : TFMGPipes.PipeMaterial.values()) {
            ...
            PUMP_COGS.put(material, block(material.name + "_mechanical_pump/cog"));
        }
        ////////////////

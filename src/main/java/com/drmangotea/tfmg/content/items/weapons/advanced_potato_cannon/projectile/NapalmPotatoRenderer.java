...
public class NapalmPotatoRenderer extends EntityRenderer<NapalmPotato> {
    ...
    public void render(NapalmPotato kartofel, float p_114657_, float p_114658_, PoseStack p_114659_, MultiBufferSource p_114660_, int p_114661_) {
        ...
        p_114659_.mulPose(Axis.YP.rotationDegrees(180.0F));
                ...
                this.itemRenderer.renderStatic(TFMGItems.NAPALM_POTATO.get().getDefaultInstance(), ItemDisplayContext.GROUND, p_114661_, OverlayTexture.NO_OVERLAY, p_114659_, p_114660_,kartofel.level(), kartofel.getId());
